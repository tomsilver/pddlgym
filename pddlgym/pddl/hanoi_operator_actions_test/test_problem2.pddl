(define (problem testhanoi2)
  ...
  (:init
   ...
   (on d9 peg1) (on d8 d9) (on d7 d8) (on d6 d7) (on d5 d6) (on d4 d5) (on d3 d4)
   (on d2 d3) (on d1 d2)
  )
  (:goal (and (on d9 peg3) (on d8 d9) (on d7 d8) (on d6 d7) (on d5 d6) (on d4 d5)
