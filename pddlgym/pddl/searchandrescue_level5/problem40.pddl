...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f8-4f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f9-0f)
	(person-at person1 f6-1f)
	(person-at person2 f1-3f)
  ...
  (:goal (and
	(person-at person4 f8-4f)
	(person-at person3 f8-4f)
	(person-at person2 f8-4f)
	(person-at person0 f8-4f)))
)
