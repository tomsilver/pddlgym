...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(move right)
	(move up)
	(person-at person0 f7-6f)
	(person-at person1 f6-6f)
	(person-at person2 f1-8f)
	(person-at person3 f4-2f)
	(person-at person4 f0-2f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f5-7f)
	(wall-at wall0 f1-4f)
  ...
  (:goal (and
	(person-at person4 f1-5f)
	(person-at person1 f1-5f)
	(person-at person2 f1-5f)
	(person-at person3 f1-5f)))
)
