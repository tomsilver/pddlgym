...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f4-3f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f8-9f)
	(person-at person1 f2-1f)
	(person-at person2 f7-8f)
	(person-at person3 f3-3f)
	(person-at person4 f9-0f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f4-1f)
	(wall-at wall0 f1-4f)
  ...
  (:goal (and
	(person-at person1 f4-3f)
	(person-at person0 f4-3f)
	(person-at person2 f4-3f)
	(person-at person4 f4-3f)))
)
