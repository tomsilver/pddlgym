...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f7-4f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f2-0f)
	(person-at person1 f9-2f)
	(person-at person2 f2-9f)
	(person-at person3 f6-8f)
	(person-at person4 f9-1f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f5-3f)
	(wall-at wall0 f1-4f)
  ...
  (:goal (and
	(person-at person2 f7-4f)
	(person-at person4 f7-4f)))
)
