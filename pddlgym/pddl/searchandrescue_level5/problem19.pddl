...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f0-2f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f3-2f)
	(person-at person1 f1-9f)
	(person-at person2 f5-6f)
	(person-at person3 f1-8f)
	(person-at person4 f7-7f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f6-0f)
	(wall-at wall0 f1-4f)
