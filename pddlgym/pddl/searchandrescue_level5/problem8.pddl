...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(person-at person2 f7-9f)
	(person-at person3 f3-8f)
  ...
  (:goal (and
	(person-at person3 f2-1f)
	(person-at person4 f2-1f)
	(person-at person0 f2-1f)
	(person-at person2 f2-1f)
	(person-at person1 f2-1f)))
)
