...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f1-7f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f6-1f)
	(person-at person1 f8-1f)
	(person-at person2 f2-0f)
	(person-at person3 f2-4f)
	(person-at person4 f4-8f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	...
	(wall-at wall0 f1-4f)
	(wall-at wall10 f6-4f)
	(wall-at wall11 f6-7f)
	(wall-at wall12 f6-9f)
	(wall-at wall13 f7-5f)
	(wall-at wall14 f7-7f)
  ...
  (:goal (and
	(person-at person3 f1-7f)
	(person-at person1 f1-7f)
	(person-at person0 f1-7f)
	(person-at person4 f1-7f)
	(person-at person2 f1-7f)))
)
