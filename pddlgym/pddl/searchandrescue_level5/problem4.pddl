...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f9-1f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f5-9f)
	(person-at person1 f0-8f)
	(person-at person2 f1-6f)
	(person-at person3 f9-7f)
  ...
  (:goal (and
	...
	(person-at person2 f9-1f)
	(person-at person0 f9-1f)
	(person-at person1 f9-1f)))
)
