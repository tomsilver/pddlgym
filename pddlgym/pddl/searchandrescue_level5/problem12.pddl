...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f7-3f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f2-3f)
	(person-at person1 f2-3f)
	(person-at person2 f7-7f)
	(person-at person3 f1-4f)
	(person-at person4 f6-7f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f5-1f)
	(wall-at wall0 f1-5f)
	(wall-at wall10 f6-1f)
	(wall-at wall11 f6-3f)
	(wall-at wall12 f6-4f)
	(wall-at wall13 f6-9f)
	(wall-at wall14 f7-5f)
	(wall-at wall15 f7-9f)
	(wall-at wall16 f8-2f)
	(wall-at wall17 f8-7f)
	(wall-at wall18 f9-2f)
	(wall-at wall19 f9-5f)
	(wall-at wall1 f1-6f)
	(wall-at wall20 f9-7f)
	(wall-at wall2 f2-4f)
	(wall-at wall3 f2-6f)
	(wall-at wall4 f3-4f)
	(wall-at wall5 f4-3f)
  ...
  (:goal (and
	(person-at person1 f7-3f)
	(person-at person3 f7-3f)
	(person-at person2 f7-3f)
	(person-at person4 f7-3f)
	(person-at person0 f7-3f)))
)
