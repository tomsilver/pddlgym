...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f4-0f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f5-3f)
	(person-at person1 f6-7f)
	(person-at person2 f0-3f)
	(person-at person3 f2-0f)
	(person-at person4 f7-0f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f9-7f)
	(wall-at wall0 f1-4f)
  ...
  (:goal (and
	(person-at person1 f4-0f)
	(person-at person4 f4-0f)
	(person-at person3 f4-0f)))
)
