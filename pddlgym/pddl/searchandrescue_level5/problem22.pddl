...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f6-1f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f9-0f)
	(person-at person1 f1-3f)
	(person-at person2 f3-1f)
	(person-at person3 f3-4f)
	(person-at person4 f3-9f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
  ...
  (:goal (and
	(person-at person4 f6-1f)
	(person-at person3 f6-1f)))
)
