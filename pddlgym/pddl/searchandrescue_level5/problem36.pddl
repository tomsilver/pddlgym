...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f4-4f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f5-9f)
	(person-at person1 f3-6f)
	(person-at person2 f0-2f)
	(person-at person3 f0-7f)
	(person-at person4 f7-1f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f1-6f)
	(wall-at wall0 f1-4f)
  ...
  (:goal (and
	(person-at person2 f4-4f)
	(person-at person4 f4-4f)
	(person-at person3 f4-4f)
	(person-at person0 f4-4f)
	(person-at person1 f4-4f)))
)
