...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f3-2f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f3-9f)
	(person-at person1 f1-6f)
	(person-at person2 f9-3f)
	(person-at person3 f7-7f)
	(person-at person4 f5-2f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f6-5f)
	(wall-at wall0 f1-4f)
