...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f1-1f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f8-6f)
	(person-at person1 f3-2f)
	(person-at person2 f2-4f)
  ...
  (:goal (and
	(person-at person4 f1-1f)
	(person-at person2 f1-1f)))
)
