...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f4-6f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f0-3f)
	(person-at person1 f3-4f)
	(person-at person2 f1-0f)
	(person-at person3 f4-6f)
	(person-at person4 f8-2f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f0-9f)
	(wall-at wall0 f1-4f)
  ...
  (:goal (and
	(person-at person3 f4-6f)
	(person-at person0 f4-6f)
	(person-at person4 f4-6f)
	(person-at person2 f4-6f)
	(person-at person1 f4-6f)))
)
