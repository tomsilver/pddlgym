...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f9-8f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f1-7f)
	(person-at person1 f6-8f)
	(person-at person2 f4-3f)
	(person-at person3 f5-2f)
	(person-at person4 f0-1f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f9-6f)
	(wall-at wall0 f1-4f)
  ...
  (:goal (and
	(person-at person4 f9-8f)
	(person-at person3 f9-8f)
	(person-at person1 f9-8f)
	(person-at person0 f9-8f)
	(person-at person2 f9-8f)))
)
