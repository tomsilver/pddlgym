...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f1-0f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f5-0f)
	(person-at person1 f1-4f)
	(person-at person2 f1-9f)
	(person-at person3 f0-3f)
	(person-at person4 f9-3f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f6-8f)
	(wall-at wall0 f1-5f)
  ...
  (:goal (and
	(person-at person1 f1-0f)
	(person-at person3 f1-0f)
	(person-at person2 f1-0f)
	(person-at person4 f1-0f)))
)
