(define (problem doors) 
	...
	(moveto loc-6-4)
	(locinroom loc-6-5 room-1)
	(moveto loc-6-5)
	(locinroom loc-6-6 room-1)
	(moveto loc-6-6)
	(locinroom loc-6-7 room-1)
	(moveto loc-6-7)
	(locinroom loc-7-0 room-2)
	(moveto loc-7-0)
	(locinroom loc-7-1 room-2)
	(moveto loc-7-1)
	(locinroom loc-7-2 room-2)
	(moveto loc-7-2)
	(locinroom loc-7-3 room-2)
	(moveto loc-7-3)
	(locinroom loc-7-4 room-2)
	(moveto loc-7-4)
	(locinroom loc-7-5 room-2)
	(moveto loc-7-5)
	(locinroom loc-7-6 room-2)
	(moveto loc-7-6)
	(locinroom loc-7-7 room-2)
	(moveto loc-7-7)
    ...
    (:goal (and (at loc-7-7) (not (keyat key-0 loc-4-4)) (not (keyat key-1 loc-6-0))))
)
