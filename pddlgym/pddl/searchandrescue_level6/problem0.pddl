...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f1-9f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f7-9f)
	(person-at person1 f8-9f)
	(person-at person2 f3-5f)
	(person-at person3 f1-1f)
	(person-at person4 f0-7f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f1-1f)
	(wall-at wall0 f0-1f)
	(wall-at wall10 f5-5f)
	(wall-at wall11 f5-6f)
	(wall-at wall12 f5-8f)
	(wall-at wall13 f6-4f)
	(wall-at wall14 f6-7f)
	(wall-at wall15 f6-8f)
	(wall-at wall16 f7-0f)
	(wall-at wall17 f7-1f)
	(wall-at wall18 f7-2f)
	(wall-at wall19 f7-7f)
	(wall-at wall1 f0-3f)
	(wall-at wall20 f8-5f)
	(wall-at wall21 f9-1f)
	(wall-at wall2 f0-5f)
	(wall-at wall3 f0-8f)
	(wall-at wall4 f0-9f)
	(wall-at wall5 f1-2f)
  ...
  (:goal (and
	(person-at person1 f1-9f)
	(person-at person4 f1-9f)
	(person-at person3 f1-9f)
	(person-at person2 f1-9f)
	(person-at person0 f1-9f)))
)
