...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f7-9f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f7-5f)
	(person-at person1 f0-0f)
	(person-at person2 f5-7f)
	(person-at person3 f9-3f)
	(person-at person4 f2-9f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f3-1f)
	(wall-at wall0 f0-3f)
	(wall-at wall10 f5-5f)
	(wall-at wall11 f6-2f)
	(wall-at wall12 f6-6f)
	(wall-at wall13 f6-7f)
	(wall-at wall14 f6-9f)
	(wall-at wall15 f8-6f)
	(wall-at wall16 f8-8f)
	(wall-at wall17 f8-9f)
	(wall-at wall1 f0-6f)
	(wall-at wall2 f0-9f)
	(wall-at wall3 f1-1f)
	(wall-at wall4 f1-2f)
