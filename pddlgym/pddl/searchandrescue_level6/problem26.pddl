...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f5-1f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f1-1f)
	(person-at person1 f8-5f)
	(person-at person2 f6-7f)
	...
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f8-7f)
	(wall-at wall0 f0-1f)
	(wall-at wall10 f4-7f)
	(wall-at wall11 f5-3f)
	(wall-at wall12 f5-6f)
	(wall-at wall13 f6-1f)
	(wall-at wall14 f6-4f)
	(wall-at wall15 f6-8f)
	(wall-at wall16 f7-0f)
	(wall-at wall17 f9-2f)
	(wall-at wall18 f9-3f)
	(wall-at wall19 f9-8f)
	(wall-at wall1 f0-5f)
	(wall-at wall2 f0-7f)
	(wall-at wall3 f0-8f)
	(wall-at wall4 f1-2f)
  ...
  (:goal (and
	(person-at person3 f5-1f)
	(person-at person1 f5-1f)
	(person-at person2 f5-1f)
	(person-at person4 f5-1f)))
)
