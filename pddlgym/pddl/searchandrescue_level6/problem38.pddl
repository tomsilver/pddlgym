...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f7-0f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f5-2f)
	(person-at person1 f6-5f)
	(person-at person2 f6-1f)
	(person-at person3 f4-5f)
	(person-at person4 f6-8f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f4-8f)
	(wall-at wall0 f0-2f)
	(wall-at wall10 f5-4f)
	(wall-at wall11 f5-6f)
	(wall-at wall12 f5-9f)
	(wall-at wall13 f6-0f)
	(wall-at wall14 f6-9f)
	(wall-at wall15 f7-8f)
	(wall-at wall16 f8-6f)
	(wall-at wall17 f8-8f)
	(wall-at wall18 f8-9f)
	(wall-at wall19 f9-1f)
	(wall-at wall1 f0-3f)
	(wall-at wall2 f0-4f)
	(wall-at wall3 f0-5f)
	(wall-at wall4 f0-8f)
  ...
  (:goal (and
	(person-at person3 f7-0f)
	(person-at person4 f7-0f)
	(person-at person1 f7-0f)
