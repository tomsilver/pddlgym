...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f1-8f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f2-8f)
	(person-at person1 f2-9f)
	(person-at person2 f5-6f)
	(person-at person3 f5-3f)
	(person-at person4 f6-6f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	...
	(wall-at wall0 f0-3f)
	(wall-at wall10 f5-2f)
	(wall-at wall11 f5-5f)
	(wall-at wall12 f5-7f)
	(wall-at wall13 f5-8f)
	(wall-at wall14 f6-1f)
	(wall-at wall15 f6-7f)
	(wall-at wall16 f7-0f)
	(wall-at wall17 f7-9f)
	(wall-at wall18 f8-0f)
	(wall-at wall19 f8-6f)
	(wall-at wall1 f0-7f)
	(wall-at wall20 f8-7f)
	(wall-at wall21 f9-6f)
	(wall-at wall2 f1-2f)
	(wall-at wall3 f1-6f)
	(wall-at wall4 f2-1f)
	(wall-at wall5 f3-0f)
