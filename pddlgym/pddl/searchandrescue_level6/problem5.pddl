...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f3-1f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f9-6f)
	(person-at person1 f7-8f)
	(person-at person2 f1-9f)
	(person-at person3 f7-3f)
	(person-at person4 f7-9f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f5-8f)
	(wall-at wall0 f0-1f)
	(wall-at wall10 f4-0f)
	(wall-at wall11 f4-1f)
	(wall-at wall12 f4-2f)
	(wall-at wall13 f4-7f)
	(wall-at wall14 f4-9f)
	(wall-at wall15 f5-2f)
	(wall-at wall16 f5-3f)
	(wall-at wall17 f6-3f)
	(wall-at wall18 f6-5f)
	(wall-at wall19 f6-7f)
	(wall-at wall1 f0-3f)
	(wall-at wall20 f8-7f)
	(wall-at wall21 f8-9f)
	(wall-at wall22 f9-0f)
	(wall-at wall23 f9-1f)
	(wall-at wall24 f9-3f)
	(wall-at wall2 f0-6f)
	(wall-at wall3 f1-6f)
	(wall-at wall4 f1-8f)
	(wall-at wall5 f2-4f)
