...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(person-at person2 f5-0f)
	(person-at person3 f0-8f)
	...
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f7-0f)
	(wall-at wall0 f0-5f)
	(wall-at wall10 f7-7f)
	(wall-at wall11 f7-8f)
	(wall-at wall12 f7-9f)
	(wall-at wall13 f8-0f)
	(wall-at wall14 f8-5f)
	(wall-at wall15 f9-4f)
	(wall-at wall16 f9-7f)
	(wall-at wall1 f1-6f)
	(wall-at wall2 f1-9f)
	(wall-at wall3 f2-4f)
	(wall-at wall4 f2-5f)
  ...
  (:goal (and
	...
	(person-at person4 f5-4f)
	(person-at person3 f5-4f)
	(person-at person0 f5-4f)
	(person-at person1 f5-4f)))
)
