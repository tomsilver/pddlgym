...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f6-3f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f4-5f)
	(person-at person1 f6-3f)
	(person-at person2 f7-8f)
	(person-at person3 f4-1f)
	(person-at person4 f9-4f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f1-9f)
	(wall-at wall0 f0-2f)
	(wall-at wall10 f3-5f)
	(wall-at wall11 f3-6f)
	(wall-at wall12 f4-3f)
	(wall-at wall13 f5-3f)
	(wall-at wall14 f5-4f)
	(wall-at wall15 f5-5f)
	(wall-at wall16 f6-4f)
	(wall-at wall17 f6-6f)
	(wall-at wall18 f6-9f)
	(wall-at wall19 f7-1f)
	(wall-at wall1 f0-4f)
	(wall-at wall20 f7-4f)
	(wall-at wall21 f7-5f)
	(wall-at wall22 f8-1f)
	(wall-at wall23 f8-5f)
	(wall-at wall24 f8-6f)
	(wall-at wall25 f9-0f)
	(wall-at wall26 f9-1f)
	(wall-at wall27 f9-3f)
	(wall-at wall28 f9-6f)
	(wall-at wall2 f0-8f)
	(wall-at wall3 f0-9f)
	(wall-at wall4 f1-6f)
	(wall-at wall5 f2-0f)
  ...
  (:goal (and
	(person-at person3 f6-3f)
	(person-at person1 f6-3f)
	(person-at person4 f6-3f)
	(person-at person2 f6-3f)))
)
