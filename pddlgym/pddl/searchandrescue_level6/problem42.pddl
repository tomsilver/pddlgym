...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f1-6f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f3-6f)
	(person-at person1 f6-0f)
	(person-at person2 f4-5f)
	(person-at person3 f9-1f)
	(person-at person4 f1-3f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f2-6f)
	(wall-at wall0 f0-2f)
	(wall-at wall10 f3-7f)
	(wall-at wall11 f3-8f)
	(wall-at wall12 f4-3f)
	(wall-at wall13 f4-7f)
	(wall-at wall14 f4-8f)
	(wall-at wall15 f5-0f)
	(wall-at wall16 f5-2f)
	(wall-at wall17 f5-5f)
	(wall-at wall18 f5-8f)
	(wall-at wall19 f7-1f)
	(wall-at wall1 f0-5f)
	(wall-at wall20 f7-6f)
	(wall-at wall21 f8-3f)
	(wall-at wall22 f8-4f)
	(wall-at wall23 f8-8f)
	(wall-at wall24 f8-9f)
	(wall-at wall25 f9-6f)
	(wall-at wall2 f0-6f)
	(wall-at wall3 f1-7f)
	(wall-at wall4 f1-8f)
	(wall-at wall5 f2-0f)
  ...
  (:goal (and
	(person-at person0 f1-6f)
	(person-at person3 f1-6f)))
)
