...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f0-9f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f4-0f)
	(person-at person1 f9-1f)
	(person-at person2 f6-3f)
	(person-at person3 f4-6f)
	(person-at person4 f3-3f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f6-3f)
	(wall-at wall0 f0-6f)
	(wall-at wall10 f4-7f)
	(wall-at wall11 f5-1f)
	(wall-at wall12 f5-2f)
	(wall-at wall13 f5-9f)
	(wall-at wall14 f6-4f)
	(wall-at wall15 f6-7f)
	(wall-at wall16 f8-0f)
	(wall-at wall17 f9-3f)
	(wall-at wall18 f9-6f)
	(wall-at wall1 f1-1f)
	(wall-at wall2 f1-2f)
	(wall-at wall3 f1-8f)
	(wall-at wall4 f2-0f)
  ...
  (:goal (and
	(person-at person3 f0-9f)
	(person-at person0 f0-9f)
