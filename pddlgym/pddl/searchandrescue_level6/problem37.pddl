...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f4-5f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f2-6f)
	(person-at person1 f8-5f)
	(person-at person2 f9-6f)
	(person-at person3 f9-5f)
	(person-at person4 f3-4f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	...
	(wall-at wall0 f0-2f)
	(wall-at wall10 f5-3f)
	(wall-at wall11 f5-7f)
	(wall-at wall12 f5-9f)
	(wall-at wall13 f6-0f)
	(wall-at wall14 f6-1f)
	(wall-at wall15 f6-7f)
	(wall-at wall16 f7-1f)
	(wall-at wall17 f7-4f)
	(wall-at wall18 f7-8f)
  ...
  (:goal (and
	(person-at person1 f4-5f)
	(person-at person2 f4-5f)
	(person-at person4 f4-5f)
	(person-at person3 f4-5f)))
)
