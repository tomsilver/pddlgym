...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f3-8f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f2-4f)
	(person-at person1 f3-1f)
	(person-at person2 f6-5f)
	(person-at person3 f8-4f)
	(person-at person4 f3-6f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f0-7f)
	(wall-at wall0 f1-4f)
