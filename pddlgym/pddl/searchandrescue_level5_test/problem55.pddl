...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f0-6f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f9-6f)
	(person-at person1 f2-3f)
	(person-at person2 f2-0f)
	(person-at person3 f9-6f)
	(person-at person4 f1-4f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f2-0f)
	(wall-at wall0 f1-5f)
  ...
  (:goal (and
	(person-at person3 f0-6f)
	(person-at person0 f0-6f)
	(person-at person4 f0-6f)
	(person-at person1 f0-6f)
	(person-at person2 f0-6f)))
)
