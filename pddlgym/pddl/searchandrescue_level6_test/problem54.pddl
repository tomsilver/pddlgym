...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f5-8f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f3-2f)
	(person-at person1 f7-4f)
	(person-at person2 f0-2f)
	(person-at person3 f5-3f)
	(person-at person4 f5-6f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	...
	(wall-at wall0 f0-4f)
	(wall-at wall10 f4-4f)
	(wall-at wall11 f4-6f)
	(wall-at wall12 f5-0f)
	(wall-at wall13 f5-7f)
	(wall-at wall14 f5-9f)
	(wall-at wall15 f6-0f)
	(wall-at wall16 f6-9f)
	(wall-at wall17 f8-0f)
	(wall-at wall18 f8-6f)
