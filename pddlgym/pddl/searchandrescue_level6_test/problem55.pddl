...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f0-0f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f6-8f)
	(person-at person1 f8-3f)
	(person-at person2 f3-2f)
	...
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f4-4f)
	(wall-at wall0 f1-0f)
	(wall-at wall10 f6-3f)
	(wall-at wall11 f6-5f)
	(wall-at wall12 f6-6f)
	(wall-at wall13 f6-7f)
	(wall-at wall14 f7-0f)
	(wall-at wall15 f7-3f)
	(wall-at wall16 f7-9f)
	(wall-at wall17 f8-6f)
	(wall-at wall18 f9-4f)
	(wall-at wall1 f1-5f)
	(wall-at wall2 f2-9f)
	(wall-at wall3 f3-1f)
	(wall-at wall4 f3-3f)
  ...
  (:goal (and
	(person-at person1 f0-0f)
	(person-at person0 f0-0f)
	(person-at person4 f0-0f)
