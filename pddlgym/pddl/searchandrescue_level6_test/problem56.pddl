...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f9-2f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f9-7f)
	(person-at person1 f8-8f)
	(person-at person2 f1-3f)
	(person-at person3 f5-7f)
	...
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f1-7f)
	(wall-at wall0 f0-4f)
	(wall-at wall10 f4-1f)
	(wall-at wall11 f4-5f)
	(wall-at wall12 f4-6f)
	(wall-at wall13 f5-4f)
	(wall-at wall14 f5-5f)
	(wall-at wall15 f6-0f)
	(wall-at wall16 f6-5f)
	(wall-at wall17 f8-2f)
	(wall-at wall18 f8-7f)
	(wall-at wall19 f8-9f)
	(wall-at wall1 f0-6f)
	(wall-at wall20 f9-0f)
	(wall-at wall2 f1-1f)
	(wall-at wall3 f1-2f)
	(wall-at wall4 f2-0f)
	(wall-at wall5 f2-1f)
  ...
  (:goal (and
	(person-at person4 f9-2f)
	(person-at person0 f9-2f)
	(person-at person3 f9-2f)))
)
