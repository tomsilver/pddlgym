...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f8-2f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f6-8f)
	(person-at person1 f0-4f)
	(person-at person2 f2-0f)
	(person-at person3 f3-7f)
	...
	(wall-at wall0 f0-5f)
	(wall-at wall10 f5-9f)
	(wall-at wall11 f6-3f)
	(wall-at wall12 f7-0f)
	(wall-at wall13 f7-9f)
	(wall-at wall14 f8-1f)
	(wall-at wall15 f8-3f)
	(wall-at wall16 f8-4f)
	(wall-at wall17 f8-5f)
	(wall-at wall18 f8-9f)
	(wall-at wall19 f9-2f)
	(wall-at wall1 f1-6f)
	(wall-at wall20 f9-6f)
	(wall-at wall2 f2-1f)
	(wall-at wall3 f2-2f)
	(wall-at wall4 f2-4f)
	(wall-at wall5 f3-3f)
  ...
  (:goal (and
	(person-at person2 f8-2f)
	(person-at person3 f8-2f)
	(person-at person0 f8-2f)))
)
