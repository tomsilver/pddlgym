...
(define (problem searchandrescue) (:domain searchandrescue)
  ...
  (:init 
	...
	(dropoff )
	(handsfree robot0)
	(hospital-at hospital0 f7-2f)
	(move down)
	(move left)
	(move right)
	(move up)
	(person-at person0 f0-3f)
	(person-at person1 f5-7f)
	(person-at person2 f3-5f)
	(person-at person3 f6-2f)
	(person-at person4 f4-6f)
	(pickup person0)
	(pickup person1)
	(pickup person2)
	(pickup person3)
	(pickup person4)
	(robot-at robot0 f7-4f)
	(wall-at wall0 f0-6f)
	(wall-at wall10 f4-9f)
	(wall-at wall11 f5-3f)
	(wall-at wall12 f5-4f)
	(wall-at wall13 f5-6f)
	(wall-at wall14 f6-6f)
	(wall-at wall15 f6-8f)
	(wall-at wall16 f7-0f)
	(wall-at wall17 f7-1f)
	(wall-at wall18 f7-5f)
	(wall-at wall19 f7-7f)
	(wall-at wall1 f0-8f)
	(wall-at wall20 f8-0f)
	(wall-at wall21 f8-4f)
	(wall-at wall22 f8-6f)
	(wall-at wall23 f8-9f)
	(wall-at wall24 f9-2f)
	(wall-at wall2 f1-2f)
	(wall-at wall3 f1-6f)
	(wall-at wall4 f1-8f)
	(wall-at wall5 f2-7f)
  ...
  (:goal (and
	(person-at person2 f7-2f)
	(person-at person4 f7-2f)
	(person-at person3 f7-2f)
	(person-at person0 f7-2f)))
)
