(define (problem hanoi8)
  (:domain hanoi)
  (:objects peg1 - default peg2 - default peg3 - default d1 - default d2 - default d3 - default d4 - default d5 - default d6 - default d7 - default d8 - default)
  (:init 
   ...
   (on d8 peg1) (on d7 d8) (on d6 d7) (on d5 d6) (on d4 d5) (on d3 d4)
   (on d2 d3) (on d1 d2))
  (:goal (and (on d8 peg3) (on d7 d8) (on d6 d7) (on d5 d6) (on d4 d5)
