(define (problem gotocasino5) 
    ...
    (:goal (and (HavePrize1 prize-1-1) (HavePrize1 prize-1-2) (HavePrize2 prize-2-1) (HavePrize2 prize-2-2) (HavePrize3 prize-3-1) (HavePrize3 prize-3-2)))
)
