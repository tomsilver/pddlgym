...
def run_all(render=True, verbose=True):
    ...
    # run_async_vi_experiment("InversePlanningDoorsKeysGems-v0", list(range(9)), vi_maxiters=20000, iter_plan_interval=100)
    ...
    # run_async_vi_experiment("InversePlanningDoorsKeysGems-v0", list(range(12)), vi_maxiters=10000, iter_plan_interval=100, biased=True)
