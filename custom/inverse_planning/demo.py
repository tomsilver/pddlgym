...
def run_goal_inference_experiment(gym_name, num_problem_groups, vi_maxiters=2500, use_cache=False, biased=False,
    ...
    for group_idx in range(num_problem_groups):
        ...
        for action in plan:
            ...
            # Run goal inference
            goal_distribution, _ = infer_goal(demonstration, problem_qvals, env)
...
def run_all(render=True, verbose=True):
    ...
    # demo_random("InversePlanningTaxi-v0", render=render, verbose=verbose)
    ...
    # demo_planning("fd", "InversePlanningTaxi-v0", 12, render=render, verbose=verbose)
    # demo_planning("ff", "InversePlanningDoorsKeysGems-v0", 9, render=render, verbose=verbose)
    ...
    # run_async_vi_experiment("EasyInversePlanningDoorsKeysGems-v0", list(range(9)), vi_maxiters=20000, iter_plan_interval=100)
    ...
    # run_async_vi_experiment("InversePlanningTaxi-v0", list(range(12)), vi_maxiters=20000, iter_plan_interval=100)
    run_async_vi_experiment("InversePlanningDoorsKeysGems-v0", list(range(9)), vi_maxiters=250000, iter_plan_interval=10000, biased=False)
    ...
    # run_async_vi_experiment("InversePlanningDoorsKeysGems-v0", list(range(9)), vi_maxiters=250000, iter_plan_interval=10000, biased=True)
